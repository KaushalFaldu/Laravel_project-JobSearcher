...
class CompanyController extends Controller
{
    ...
    protected function companySave(Company $company, Request $request)
    {
        ...
        $company->logo = 'storage/app/public/companies/cover/' . $fileNameToStore;
        ...
        if ($request->hasFile('cover_img')) {
            ...
            $company->cover_img = 'storage/app/public/companies/cover/' . $fileNameToStore;
        } else {
    ...
    protected function companyUpdate(Company $company, Request $request)
    {
        ...
        if ($request->hasFile('logo')) {
            ...
            $company->logo = 'storage/app/public/companies/logos/' . $fileNameToStore;
        }
