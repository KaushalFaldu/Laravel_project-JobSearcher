        ...
        <div class="job-listing border">
          <div class="company-info">
            <div class="company-banner">
              ...
              <img src="../../{{'images/companies/nocover.jpg'}}" class="company-banner-img img-fluid" alt="">
              @else
              <img src="../../{{$company->cover_img}}" class="company-banner-img img-fluid" alt="">
              @endif
              <div class="company-media">
                <img src="{{env('IMAGE_URL')}}/{{$company->logo}}" alt="" class="company-logo">
                <div>
            ...
            <div class="similar-jobs">
              ...
              @if($similarJobs)
                <div class="job-item border-bottom row">
                  <div class="col-4">
                    <img src="{{env('IMAGE_URL')}}/{{$job->company->logo}}" class="company-logo" alt="">
                  </div>
