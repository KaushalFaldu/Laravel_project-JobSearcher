        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3> <img src="{{asset('images/logo/1.jpg')}}" width="50px;" alt=""> Job Searcher Login</h3>
                    <p class="login-header-title">Welcome back to Job Searcher</p>
...
<style>
.login-poster {
   background-image: url('{{asset("images/one.jpg")}}');
