        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3><img src="{{asset('images/logo/1.jpg')}}" width="50px;" alt=""> Create your free jobseeker account</h3>
                ...
                <div class="login-form">
                    <form action="{{route('register')}}" method="POST">
                        ...
                        <div>
                            <small class="text-muted d-block mb-3">By clicking on 'Create Jobseeker Account' below you are going to Register for the JobSearcher!</p>
                        </div>
...
.login-poster {
    /* fallback */
   background-image: url('{{asset("images/two.jpeg")}}');
    background-image: linear-gradient(
            to bottom,
            rgba(0, 0, 0, 0.5),
            rgba(0, 0, 0, 0.35)
        ),
        url('{{asset("images/two.jpeg")}}');
