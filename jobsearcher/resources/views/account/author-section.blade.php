        ...
        <div class="row mb-3">
          <div class="col-xl-4 col-sm-6 py-2">
              <div class="card dashboard-card text-white h-100 shadow">
                  <div class="card-body primary-bg" style="background-color: #26aa8f;">
                      <div class="rotate">
          ...
          <div class="col-xl-4 col-sm-6 py-2">
              <div class="card dashboard-card text-white  h-100 shadow">
                  <div class="card-body bg-info" style="    background-color: #798241 !important;">
                      <div class="rotate">
          ...
          <div class="col-xl-4 col-sm-6 py-2">
              <a href="{{route('jobApplication.index')}}">
                <div class="card dashboard-card text-white h-100 shadow">
                    <div class="card-body bg-danger"    style=" background-color: #7b6487 !important;">
                        <div class="rotate">
                              ...
                              <div class="col-sm-12 col-md-12">
                                  <div class="card">
                                      <div class="card-body text-center">
                                           <img src="{{env('IMAGE_URL')}}/{{$company->logo}}" width="100px" class="img-fluid border p-2" alt=""> 
                                          <h5>{{$company->title}}</h5>
