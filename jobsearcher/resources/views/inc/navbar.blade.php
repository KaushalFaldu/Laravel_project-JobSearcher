<nav class="navbar navbar-expand-md navbar-white bg-white border-bottom sticky-top" id="navbar" style="background-color: #06428221 !important;">
  <div class="container">
  <a href="{{URL('/')}}" class="navbar-brand">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        @endauth
        @guest
        <a href="{{route('login')}}" class="btn primary-btn">Sign up / Log in</a>
        @endguest
      </ul>
    </div>
  </div>
